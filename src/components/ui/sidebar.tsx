...
const SidebarTrigger = React.forwardRef<React.ElementRef<typeof Button>, React.ComponentProps<typeof Button>>(({
  ...
  return <Button ref={ref} data-sidebar="trigger" variant="ghost" size="icon" className={cn("h-7 w-7", className)} onClick={event => {
    ...
    toggleSidebar();
        ...
        {isMobile ? openMobile ? <X className="h-5 w-5" /> : <Menu className="h-5 w-5" /> : <PanelLeft />}
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({
  ...
  return <div ref={ref} data-sidebar="header" className={cn("flex-col gap-2 p-2 h-[65px] flex items-start justify-center", className)} {...props} />;
});
...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({
  ...
  return <div ref={ref} data-sidebar="group" className={cn("relative flex w-full min-w-0 flex-col pt-6 px-0 pb-2", className)} {...props} />;
});
...
const SidebarMenu = React.forwardRef<HTMLUListElement, React.ComponentProps<"ul">>(({
  className,
  ...props
}, ref) => <ul ref={ref} data-sidebar="menu" className={cn("flex w-full min-w-0 flex-col gap-2", className)} {...props} />);
