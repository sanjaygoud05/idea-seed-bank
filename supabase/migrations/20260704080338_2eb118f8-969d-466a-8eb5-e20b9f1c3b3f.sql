-- Tighten table grants (least privilege)
REVOKE ALL ON TABLE public.app_settings FROM anon, authenticated;
GRANT SELECT ON TABLE public.app_settings TO authenticated;
GRANT ALL ON TABLE public.app_settings TO service_role;

-- Tighten function execution surface
...
REVOKE EXECUTE ON FUNCTION public.is_manager_of(uuid, uuid) FROM authenticated;

-- Remove hardcoded demo credentials by using non-deterministic generated passwords
...
BEGIN
  ...
  VALUES
    ('00000000-0000-0000-0000-000000000000', v_manager_user, 'authenticated', 'authenticated',
     'sarah.chen@demo.local', crypt(encode(gen_random_bytes(32), 'hex'), gen_salt('bf')),
    ...
    ('00000000-0000-0000-0000-000000000000', v_emp1_user, 'authenticated', 'authenticated',
     'marcus.johnson@demo.local', crypt(encode(gen_random_bytes(32), 'hex'), gen_salt('bf')),
    ...
    ('00000000-0000-0000-0000-000000000000', v_emp2_user, 'authenticated', 'authenticated',
     'priya.patel@demo.local', crypt(encode(gen_random_bytes(32), 'hex'), gen_salt('bf')),
