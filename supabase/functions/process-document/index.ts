    ...
    const {error:aiError}=
      ...
      .insert({
        ...
        insight:
          ...
          `Total carbon emission calculated is ${totalCarbon.toFixed(2)} kg CO2`,
        ...
        recommendation:
          ...
          "Reduce electricity consumption, optimize fuel usage, improve waste management and increase renewable energy adoption.",
